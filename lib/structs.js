...
export const STRUCTS = {
  ...
  hcp: {
    ...
    // Primitive hexagonal cell (60°/120° rhombic prism, matching the same
    // corners-of-one-cell convention used for sc/bcc/fcc above): 8 corner
    // atoms of the 'A' layer plus 1 interior 'B' atom at the standard hcp
    // Wyckoff position (1/3, 2/3, 1/2). Verified: with these lv vectors this
    // places every drawn nearest-neighbor pair exactly CS apart (ideal
    // close-packing), unlike the previous denser atom list which crammed
    // extra atoms at half that spacing and made the cell look like an
    // overlapping blob instead of a clean hexagonal prism.
    lv:[
      [CS,     0,          0      ],
      [-CS/2,  CS*0.8660,  0      ],
      [0,      0,          CS*1.633]
    ...
    atoms:[
      {f:[0,0,0],         c:0x66bb6a, lb:'A'},
      {f:[1,0,0],         c:0x66bb6a, lb:'A'},
      {f:[0,1,0],         c:0x66bb6a, lb:'A'},
      {f:[0,0,1],         c:0x66bb6a, lb:'A'},
      {f:[1,1,0],         c:0x66bb6a, lb:'A'},
      {f:[1,0,1],         c:0x66bb6a, lb:'A'},
      {f:[0,1,1],         c:0x66bb6a, lb:'A'},
      {f:[1,1,1],         c:0x66bb6a, lb:'A'},
      {f:[1/3, 2/3, 0.5], c:0x2e7d32, lb:'B'}
    ],
    bondRule:'hcp',
  ...
  cscl: {
    ...
    bondRule:'ionic',
    z:1, cn:'8 – 8', apf:'68.3%', param:'d(Cs–Cl) = a√3/2',
  ...
  nacl: {
    ...
    atoms:[
      ...
      {f:[1,0,0.5],c:0x42a5f5,r:1.02,lb:'Na⁺'},
    ],
    bondRule:'ionic',
    z:4, cn:'6 – 6', apf:'64.6%', param:'d(Na–Cl) = a/2',
  ...
  zns: {
    ...
    bondRule:'ionic',
    z:4, cn:'4 – 4', apf:'52.6%', param:'d(Zn–S) = a√3/4',
  ...
  caf2: {
    ...
    bondRule:'ionic',
    z:4, cn:'8 (Ca) / 4 (F)', apf:'61.4%', param:'d(Ca–F) = a√3/4',
  ...
  tet_p: {
    ...
    bondRule:'metal',
    z:1, cn:4, apf:'~33%', param:'a=b, c≠a, α=β=γ=90°',
  ...
  tet_i: {
    ...
    bondRule:'metal',
    z:2, cn:4, apf:'~65%', param:'a=b, c≠a, α=β=γ=90°',
  ...
  ort_p: {
    ...
    bondRule:'metal',
    z:1, cn:2, apf:'~21%', param:'a≠b≠c, α=β=γ=90°',
  ...
  ort_i: {
    ...
    bondRule:'metal',
    z:2, cn:2, apf:'~42%', param:'a≠b≠c, α=β=γ=90°',
    examples:'CrB, TiSi₂',
    system:'sysOI',
  ...
  ort_f: {
    ...
    bondRule:'metal',
    z:4, cn:4, apf:'~53%', param:'a≠b≠c, α=β=γ=90°',
  ...
  ort_c: {
    ...
    bondRule:'metal',
    z:2, cn:4, apf:'~26%', param:'a≠b≠c, α=β=γ=90°',
    examples:'KNO₃, BaSO₄',
    system:'sysOC',
  ...
  hex_p: {
    ...
    bondRule:'metal',
    z:1, cn:6, apf:'~38%', param:'a=b≠c, α=β=90°, γ=120°',
  ...
  rho_r: {
    ...
    bondRule:'metal',
    z:1, cn:12, apf:'~74%', param:'a=b=c, α=β=γ≠90°',
  ...
  mon_p: {
    ...
    bondRule:'metal',
    z:1, cn:2, apf:'~27%', param:'a≠b≠c, α=γ=90°, β=110°',
  ...
  mon_c: {
    ...
    bondRule:'metal',
    z:2, cn:4, apf:'~30%', param:'a≠b≠c, α=γ=90°, β=110°',
  ...
  tri_p: (() => {
    ...
    return {
      ...
      bondRule:'metal',
      z:1, cn:2, apf:'~31%', param:'a≠b≠c, α=95°, β=110°, γ=80°',
...
// All structures whose lattice is geometrically cubic (a=b=c, 90° angles) —
// includes the diatomic/ionic cubic structures (cscl, nacl, zns, caf2,
// diamond), not just the three under the "Cubic" dropdown heading, since
// the grouping there is by name/composition rather than by lattice system.
export const CUBIC_STRUCT_KEYS = ['sc', 'bcc', 'fcc', 'cscl', 'nacl', 'zns', 'caf2', 'diamond']
